...
type FnucExprParser struct {
	*antlr.BaseParser
}

func NewFnucExprParser(input antlr.TokenStream) *FnucExprParser {
	this := new(FnucExprParser)
	...
	this.GrammarFileName = "FnucExpr.g4"

	return this
}

// FnucExprParser tokens.
const (
	FnucExprParserEOF        = antlr.TokenEOF
	FnucExprParserT__0       = 1
	FnucExprParserT__1       = 2
	FnucExprParserT__2       = 3
	FnucExprParserStringArg  = 4
	FnucExprParserFloatArg   = 5
	FnucExprParserIntArg     = 6
	FnucExprParserFuncName   = 7
	FnucExprParserMethodName = 8
	FnucExprParserDot        = 9
	FnucExprParserFloat      = 10
	FnucExprParserWHITESPACE = 11
)

// FnucExprParser rules.
const (
	FnucExprParserRULE_start        = 0
	FnucExprParserRULE_methodCall   = 1
	FnucExprParserRULE_functionCall = 2
	FnucExprParserRULE_functionArgs = 3
)
...
func NewEmptyStartContext() *StartContext {
	...
	p.RuleIndex = FnucExprParserRULE_start
	return p
}
...
func (s *StartContext) EOF() antlr.TerminalNode {
	return s.GetToken(FnucExprParserEOF, 0)
}
...
func (s *StartContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(FnucExprListener); ok {
...
func (p *FnucExprParser) Start() (localctx IStartContext) {
	localctx = NewStartContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 0, FnucExprParserRULE_start)
...
func NewEmptyMethodCallContext() *MethodCallContext {
	...
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = FnucExprParserRULE_methodCall
	return p
}
...
func (s *MethodCallContext) MethodName() antlr.TerminalNode {
	return s.GetToken(FnucExprParserMethodName, 0)
}
...
func (p *FnucExprParser) MethodCall() (localctx IMethodCallContext) {
	localctx = NewMethodCallContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 2, FnucExprParserRULE_methodCall)
	var _la int
	...
	{
		p.SetState(14)
		p.Match(FnucExprParserMethodName)
	}
	{
		p.SetState(15)
		p.Match(FnucExprParserT__0)
	}
	p.SetState(17)
	p.GetErrorHandler().Sync(p)
	_la = p.GetTokenStream().LA(1)

	if ((_la)&-(0x1f+1)) == 0 && ((1<<uint(_la))&((1<<FnucExprParserStringArg)|(1<<FnucExprParserFloatArg)|(1<<FnucExprParserIntArg))) != 0 {
		{
			p.SetState(16)
			p.FunctionArgs()
		}
...
func NewEmptyFunctionCallContext() *FunctionCallContext {
	...
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = FnucExprParserRULE_functionCall
	return p
}
...
func (s *FuncCallContext) FuncName() antlr.TerminalNode {
	return s.GetToken(FnucExprParserFuncName, 0)
}
...
func (p *FnucExprParser) FunctionCall() (localctx IFunctionCallContext) {
	localctx = NewFunctionCallContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 4, FnucExprParserRULE_functionCall)
	var _la int
	...
	{
		p.SetState(21)
		p.Match(FnucExprParserFuncName)
	}
	{
		p.SetState(22)
		p.Match(FnucExprParserT__0)
...
func NewEmptyFunctionArgsContext() *FunctionArgsContext {
	...
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = FnucExprParserRULE_functionArgs
	return p
}
...
func (p *FnucExprParser) FunctionArgs() (localctx IFunctionArgsContext) {
	localctx = NewFunctionArgsContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 6, FnucExprParserRULE_functionArgs)
	var _la int
	...
	for _la == FnucExprParserT__2 {
		{
			p.SetState(29)
			p.Match(FnucExprParserT__2)
		}
		{
			p.SetState(30)
			_la = p.GetTokenStream().LA(1)
