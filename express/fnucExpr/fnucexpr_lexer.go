...
func NewFnucExprLexer(input antlr.CharStream) *FnucExprLexer {
	...
	l.GrammarFileName = "FnucExpr.g4"
	// TODO: l.EOF = antlr.TokenEOF

	return l
}

// FnucExprLexer tokens.
const (
	FnucExprLexerT__0       = 1
	FnucExprLexerT__1       = 2
	FnucExprLexerT__2       = 3
	FnucExprLexerStringArg  = 4
	FnucExprLexerFloatArg   = 5
	FnucExprLexerIntArg     = 6
	FnucExprLexerFuncName   = 7
	FnucExprLexerMethodName = 8
	FnucExprLexerDot        = 9
	FnucExprLexerFloat      = 10
	FnucExprLexerWHITESPACE = 11
)
